...
class Presupuesto_Recargos_Directo_A_Items_Test extends TestCase
{
     ...
     *
     * No es hipotetico: hoy `vender_presupuestos.js::actualizar()` no manda
     * `aplicar_recargos_directo_a_items` en el PUT. Si `update()` lo asignara pelado, editar un
     * presupuesto guardado con la opcion activa lo dejaria con el flag en null y los precios del
     * pivot todavia recargados. El update no valida el total, asi que no falla ahi: revienta
     * despues, al confirmar, con una venta inflada el porcentaje del recargo.
     *
     * @group presupuestos
     * @test
     */
