...
class FerreteriaArticlesSeeder extends Seeder
{
     ...
     *    generico que Commons indexa mejor, y estan elegidos uno por uno mirando que foto
     *    devuelve cada uno: "air filter" trae un filtro de gabinete de PC y hay que pedir
     *    "engine air filter"; "rust" trae oxido y hay que pedir "rust remover". Si agregas un
     *    articulo, corré semilla:imagenes y mirá el titulo de Commons que imprime.
    ...
    public function get_catalog()
    {
        return [
            ...
            ['name' => 'ESCOBILLON 375 X 45MM CERDA RIGIDA GARDEX', 'bar_code' => '', 'provider_code' => '35641', 'cost' => 3557, 'stock' => 40, 'sub_category_name' => 'Herramientas Manuales', 'brand_name' => 'GARDEX', 'imagen_nombre' => 'escobillon', 'imagen_busqueda' => 'floor brush', 'perfil_stock' => 'A'],
            ...
            ['name' => 'VOLANTE STIHL MS210 / 250 / 021 / 025', 'bar_code' => '795711514785', 'provider_code' => '1123-400-1203', 'cost' => 27, 'stock' => 40, 'sub_category_name' => 'Jardineria y Forestal', 'brand_name' => 'STIHL', 'imagen_nombre' => 'volante-de-motor', 'imagen_busqueda' => 'flywheel', 'perfil_stock' => 'B'],
            ...
            ['name' => 'LIMPIADOR QUITA OXIDO (FOSFATIZANTE) X 1LT', 'bar_code' => '7798120640703', 'provider_code' => '7200', 'cost' => 4647, 'stock' => 40, 'sub_category_name' => 'Adhesivos y Selladores', 'brand_name' => 'Generica', 'imagen_nombre' => 'quita-oxido', 'imagen_busqueda' => 'rust remover', 'perfil_stock' => 'B'],
