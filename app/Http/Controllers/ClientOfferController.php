...
{
    /** Vigencia máxima: más allá deja de ser una oferta y pasa a ser el precio. */
    ...
    public function store(Request $request) {
        ...
        $datos = [
            'offer_suggestion_line_id' => (int) $request->input('offer_suggestion_line_id', 0),
        ...
        $linea = $this->linea_del_usuario($datos['offer_suggestion_line_id']);
        if (!$linea) {
        ...
        } elseif ($datos['porcentaje'] > $techo['techo']) {
        ...
        $offer = $this->activar($linea, $tipo_descuento, $datos['porcentaje'], $hasta, $tramos);
