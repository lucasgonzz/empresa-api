...
class PuntosBaseHelper {
     ...
     */
    static function calcular_grupos($sale, $sistema) {
        ...
        foreach ($sale->articles as $article) {
            ...
            $bruta_por_lista[$clave] += $neto_unitario * $unidades_vendidas * $factor_descuento;
            $neta_por_lista[$clave]  += $neto_unitario * $unidades_netas    * $factor_descuento;
        }
