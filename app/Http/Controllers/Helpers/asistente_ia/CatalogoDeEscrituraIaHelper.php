...
class CatalogoDeEscrituraIaHelper
{
    ...
    const ENTIDADES = [
        ...
        'category_price_type_range' => [
            ...
            'solo_lectura'       => [],
            'claves_de_pantalla' => [],
            'ruta'               => ['name' => 'abm', 'params' => ['view' => 'precios', 'sub_view' => 'rangos-de-precio-por-categoria'], 'texto' => 'Ver en ABM'],
            'aviso_de_baja'      => null,
            'aviso_de_alta'      => null,
            'extension'          => null,
        ...
        'delivery_day' => [
            ...
            'solo_lectura'       => [],
            'claves_de_pantalla' => [],
            'ruta'               => ['name' => 'abm', 'params' => ['view' => 'tienda online', 'sub_view' => 'dias-de-entrega'], 'texto' => 'Ver en ABM'],
            'aviso_de_baja'      => null,
            'aviso_de_alta'      => null,
            'extension'          => null,
        ...
        'promocion_vinoteca_commission' => [
            ...
            'solo_lectura'       => [],
            'claves_de_pantalla' => [],
            'ruta'               => ['name' => 'abm', 'params' => ['view' => 'comisiones', 'sub_view' => 'comisiones-por-promocion'], 'texto' => 'Ver en ABM'],
            'aviso_de_baja'      => null,
            'aviso_de_alta'      => null,
            'extension'          => null,
