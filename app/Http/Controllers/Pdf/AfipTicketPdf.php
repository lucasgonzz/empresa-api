...
class AfipTicketPdf extends fpdf {
	...
	function __construct($current_acount) {
    	...
    	$this->afip_helper = new AfipHelper($this->afip_ticket, $current_acount->articles, $current_acount->services, null, $this->sale, $this->model->nota_credito_descriptions, $current_acount);
