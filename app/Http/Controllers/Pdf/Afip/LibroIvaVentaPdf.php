...
/**
 * PDF del libro de IVA ventas (débito fiscal).
 */
class LibroIvaVentaPdf extends fpdf {

	/** @var array Comprobantes normalizados para la tabla. */
	protected $comprobantes;

	/** @var object Usuario emisor del reporte. */
	protected $user;

	/** @var PdfHelper2 Helper de armado de PDF. */
	protected $pdf;

	/**
	 * Genera el PDF en orientación horizontal.
	 *
	 * @param array $comprobantes Filas del libro.
	 * @param Carbon $inicio Inicio del período.
	 * @param Carbon $fin Fin del período.
	 */
	...
	/**
	 * Encabezado del reporte con período y datos del negocio.
	 *
	 * @param Carbon $inicio
	 * @param Carbon $fin
	 */
	...
	/**
	 * Tabla principal con totales al pie.
	 */
	function table() {
	...
	/**
	 * Agrega fila de totales al final de la tabla.
	 *
