...
/**
 * Estado anti-CSRF de una autorización OAuth de Mercado Pago en curso (grupo 170, prompt 598).
 *
 * Responsabilidad:
 ...
 * - Validar y "consumir" (marcar usado) ese `state` cuando Mercado Pago vuelve al `callback`,
 *   para confirmar que el `code` recibido corresponde al comercio que inició el flujo y que no
 *   es un intento de reutilización.
 */
class MercadoPagoOauthState extends Model
{
    protected $table = 'mercado_pago_oauth_states';
